...
work with only a subset of the data. We filter the data to better answer the
research questions. For example, we examined missing data and determine whether
